...
class Arcface:
    ...
    def __init__(self, rec_name = 'arcface_r100_v1', model_version='1', url='10.1.3.166:8001'):
...
class DetectorInfer:
    ...
    def __init__(self, model = 'retinaface_r50_v1', output_order=None, model_version='1', url='127.0.0.1:8001'):
